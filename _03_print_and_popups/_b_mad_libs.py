...
if __name__ == '__main__':
    ...
    sentence = "If you find yourself having to cross a piranha-infested river, here's how to do it..."
    # messagebox.showinfo()
    messagebox.showinfo(title = "Mad Libs", message = sentence)
    # Get the player to enter an adjective
    adjective = simpledialog.askstring(title = "adjectives", prompt = "Enter an adjective.")
    # messagebox.showinfo()
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title = "liquids", prompt = "Enter a type of liquid")
    # Get the player to enter a body part
    body_part = simpledialog.askstring(title = "body parts", prompt = "Enter a body part")
    # Get the player to enter a verb
    verbs = simpledialog.askstring(title = "verb", prompt = "Enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title = "verb", prompt = "Enter a place")
    ...
    story = (
        ...
        "likely take a bite out of your " + body_part + " if you " + verbs + " . Whatever\n"
